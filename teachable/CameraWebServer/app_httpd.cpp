...
// 추가
static esp_err_t alert_handler(httpd_req_t *req){       // not_organized
...
static esp_err_t normal_handler(httpd_req_t *req){       // organized
...
static esp_err_t blank_handler(httpd_req_t *req){       // no_shoes
...
void startCameraServer() {
  ...
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    httpd_register_uri_handler(camera_httpd, &blank_uri);
